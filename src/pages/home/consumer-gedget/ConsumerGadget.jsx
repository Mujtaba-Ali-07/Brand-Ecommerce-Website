...
import ConsumerGadgetBanner from "../../../assets/banners/consumer-gadget.png"; // Adjust the path as necessary

import { FaLongArrowAltRight } from "react-icons/fa";

// image paths
import Pic1 from "../../../assets/consumer-gedget/1.png";
import Pic2 from "../../../assets/consumer-gedget/2.png";
import Pic3 from "../../../assets/consumer-gedget/3.png";
import Pic4 from "../../../assets/consumer-gedget/4.png";
import Pic5 from "../../../assets/consumer-gedget/5.png";
import Pic6 from "../../../assets/consumer-gedget/6.png";
import Pic7 from "../../../assets/consumer-gedget/7.png";
import Pic8 from "../../../assets/consumer-gedget/8.png";
import { Link } from "react-router-dom";

const ConsumerGadget = () => {
  const [currentSlide, setCurrentSlide] = useState(0);

  const products = [
    { name: "Smart watches", image: Pic1, price: "From USD 19" },
    { name: "Cameras", image: Pic2, price: "From USD 89" },
    { name: "Headphones", image: Pic3, price: "From USD 10" },
    { name: "Smart watches", image: Pic4, price: "From USD 90" },
    { name: "Gaming set", image: Pic5, price: "From USD 35" },
    { name: "Laptops & PC", image: Pic6, price: "From USD 340" },
    { name: "Smartphones", image: Pic7, price: "From USD 19" },
    { name: "Electric kettle", image: Pic8, price: "From USD 240" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 bg-white rounded-xl lg:shadow-lg ">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-1/3 relative rounded-xl overflow-hidden  min-h-[300px] hidden lg:block">
            <div
              style={{
                backgroundImage: `url(${ConsumerGadgetBanner})`,
          ...
          <div className="lg:hidden">
            <h2 className="text-xl font-semibold mb-2 border-b-2 border-gray-200 pb-2">
              Consumer electronics and gadgets
            </h2>
          </div>
